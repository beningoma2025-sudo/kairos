      ...
      <div className="absolute bottom-0 inset-x-0 p-4 sm:p-5 flex items-end justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            <span className="text-white/60 text-xs font-medium">{typeLabel}</span>
            {item.releaseYear && (
              <>
          ...
          {/* Title */}
          <h2
            className="text-white font-bold leading-tight mb-2 line-clamp-2"
...
export function FeaturedHeroClient({ items }: { items: ContentItem[] }) {
